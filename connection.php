	...
	<body>
		<header>
			...
			<div  class="bgcol_body">
				 <div class ="float_right"><a href="index.php"><input class="button" type="button" name="accueil" value="Accueil"></a></div>
				<br /><div class ="clear"></div>
				<br />
				<form method="GET" action="./index.php">
					<table class="table_center">
						<tr>
							<td colspan="2"><H1>Connexion &agrave; votre compte</H1><br /></td>
						</tr>
							<td colspan="2"><div class ="tahoma12"><a href="create_account.php">Cr&eacute;er un compte</a></div></td>
						<tr>
							<td>Identifiant</td>
